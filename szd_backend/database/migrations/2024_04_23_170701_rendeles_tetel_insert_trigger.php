...
return new class extends Migration
{
    ...
    {
        DB::unprepared('CREATE TRIGGER rendeles_tetel_insert_trigger AFTER INSERT ON rend_tetels
        FOR EACH ROW
        BEGIN
    ...
    {
        DB::unprepared('DROP TRIGGER rendeles_tetel_insert_trigger IF EXISTS;');
    }
};